...
public class ProductTest {
    ...
    void testInvalidGetProductId (){
        assertNotEquals("eb558e9f-1c39-460e-8860-71af6af63bd7", this.product.getId());
    }

    @Test
    void testInvalidGetProductName(){
        assertNotEquals("Farrell Muhammad Hanau", this.product.getName());
    }

    @Test
    void testInvalidGetProductQuantity(){
        assertNotEquals(99, this.product.getQuantity());
    }
}
